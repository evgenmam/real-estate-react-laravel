...
@section('main')
    ...
    @if (session('status'))
        <div id="toast-success" class="flex items-center p-4 ml-auto mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
