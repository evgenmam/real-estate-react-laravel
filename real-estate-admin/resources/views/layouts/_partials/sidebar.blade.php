<aside class="w-64" aria-label="Sidebar">
    <div class="border min-h-screen border-gray-50 py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
        <ul class="space-y-2">
            ...
            <li class="{{request()->routeIs('properties.index') ? 'bg-gray-200 rounded-lg' : ''}}">
            ...
            <li class="{{request()->routeIs('properties.create') ? 'bg-gray-200 rounded-lg' : ''}}">
                <a href="{{route('properties.create')}}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700">
                    <span class="flex-1 ml-3 whitespace-nowrap">Create property</span>
                </a>
            </li>
